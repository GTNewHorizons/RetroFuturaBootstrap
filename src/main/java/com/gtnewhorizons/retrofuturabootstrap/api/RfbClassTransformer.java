...
public interface RfbClassTransformer {
     ...
     * <p>
     * Note: This method was added in lwjgl3ify 3.0.20. If you want to support older versions you need to implement
     * transformClass too.
     * @param classLoader The class loader asking for the transformation.
     * @param context The context in which the class is being loaded.
     * @param manifest Manifest of the JAR from which the package of this class came, or null if not present.
     ...
     * <p>
     * For compatibility with lwjgl3ify 3.0.19 and lower you still need to implement this method:
     * <p>
     * <pre>{@code void transformClassIfNeeded(...) { transformClassIfNeeded(...); }}</pre>
     */
    @Deprecated
